---
title: "<code>organization:user:list</code>"
type: docs
---
...
* `--columns` (multiple values allowed)  
  Columns to display.
Available columns: id*, email*, owner*, permissions*, created_at, first_name, last_name, mfa_enabled, sso_enabled, updated_at, username (* = default columns).
