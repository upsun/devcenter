...
>}}
{{< hextra/hero-button text="What's Blackfire.io" link="docs" 
...
<!-- <div class="hx-mt-6 hx-mb-6">
{{< hextra/hero-headline >}}
  Welcome to the Upsun Developer Center
{{< /hextra/hero-headline >}}
</div>

<div class="hx-mb-12">
{{< hextra/hero-subtitle >}}
  Your central hub for all resources related to the Upsun product offerings. Deploy, experiment, optimize, merge, and repeat.
  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi quis molestie quam. Curabitur eleifend ut tortor sit amet mollis. Aenean neque elit, fermentum quis sapien eget, commodo tempus ex.
{{< /hextra/hero-subtitle >}}
</div> -->
...
{{< hextra/hero-button text="Get Started" link="docs" 
  style="background: #6046FF; border: 2px solid #6046FF;"
>}}
{{< hextra/hero-button text="What is Upsun?" link="docs" 
  style="background: white; color: black; border: 2px solid black;"
>}}
</div> -->

<!-- <div class="front-page-search hx-mt-6 hx-mb-6" style="margin-left: auto; margin-right: auto;">
{{< custom/search >}}
</div> -->
...
<div class="hx-mb-12">
{{< hextra/hero-subtitle >}}
  The latest Upsun tutorials, videos and code examples with your languages and tools. A global community of more than 7 million developers. Build something {big} with Upsun.
{{< /hextra/hero-subtitle >}}
</div> -->
...
{{< hextra/hero-button text="What is Upsun?" link="docs" 
  style="background: white; color: black; border: 2px solid black;"
>}}
{{< hextra/hero-button text="Get support" link="docs" 
  style="background: #6046FF; border: 2px solid #6046FF;"
>}}
</div> -->
...
<!-- {{< cards >}}
  ...
  {{< custom/card
        ...
        subtitle="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi quis molestie quam."
  ...
  {{< custom/card
        ...
        title="chmod 104: The floor is Lava(Moat)"
        icon="play"
        subtitle="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi quis molestie quam."
        image="images/chmod-104.png"
        imageStyle="object-fit:cover; aspect-ratio:16/9;"
  >}}

  {{< custom/card
        link="https://github.com/helixml/docs"
        title="First project incentive"
        icon="tag"
        subtitle="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi quis molestie quam."
...
<!-- {{< hextra/feature-grid >}}
  {{< hextra/feature-card
    title="Featured technical blog post"
    subtitle="Lorem ipsum dolor sit amet, consectetur adipiscing elit."
    class="hx-aspect-auto md:hx-aspect-[1.1/1] max-md:hx-min-h-[340px]"
    image="images/upsun-console-main-view.png"
...
<div class="hx-mt-6 hx-mb-6">
{{< hextra/hero-headline >}}
  Integrate Upsun into your workflows
{{< /hextra/hero-headline >}}
</div>
