...
1. Update the `image` attibute in the front matter:

    For playlists, YouTube does not generate card images by default like it does for individual videos. 
    Because of this, it's necessary that you define an image.
    You can, for exmaple, use the `YOUTUBE_ID` of the first video in the playlist.
