...
date: '2024-09-12T12:18:18-04:00'
sidebar:
    exclude: true
type: post
#################################
# Update the title
title: "Introducing First Project Incentive"

# Replace if you have a good image. 
# Images are not used (yet) on individual pages, only on lists of articles.
image: /images/first-project-incentive.webp

# Define this value if listing an external blog post not written within this site.
link: "https://upsun.com/blog/first-project-incentive/"
