---
title: "RabbitMQ"
subtitle: "Message queue service"
icon: rabbitmq
description: |
    RabbitMQ is a message broker that supports multiple messaging protocols, such as the Advanced Message Queuing Protocol (AMQP).
---
